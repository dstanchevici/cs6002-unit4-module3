...
class AntEaterPanel extends JPanel implements MouseListener, Runnable {
    ...
    // Ex. 3.29: Use the same type for declaring antQueue, but
    //  for initialization use MyQueue, which based on a linked list
    //QueueDataStructure antQueue = new MyArrayQueue ();
    QueueDataStructure antQueue = new MyQueue ();
